...
void BINDING_init_waitqueue_head(wait_queue_head_t *wqh);
void BINDING_wake_up(wait_queue_head_t *wqh);
void BINDING_init_wait_entry(wait_queue_entry_t *wqe, int flags);
