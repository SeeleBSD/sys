...
#[no_mangle]
pub extern "C" fn bronyadrm_match(parent: *mut bindings::device, _match: *mut core::ffi::c_void, aux: *mut core::ffi::c_void) -> i32 {
...
#[no_mangle]
pub extern "C" fn bronyadrm_attach(parent: *mut bindings::device, _self: *mut bindings::device, aux: *mut core::ffi::c_void) {
