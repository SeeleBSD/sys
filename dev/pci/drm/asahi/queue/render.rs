    ...
    pub(super) fn submit_render(
        ...
        let frag = GpuObject::new_init_prealloc(
            ...
            |inner, _ptr| {
                ...
                kernel::dbg!("[Submission {}] RunFragment::ver\n{:?}\n{:?}\n{:?}\n{:?}\n{:?}", id, inner.micro_seq, inner.notifier, inner.scene, inner.timestamps, fw::fragment::raw::RunFragment::ver {
                    ...
                    user_timestamp_pointers: fw::job::raw::TimestampPointers {
                        start_addr: None,
                        end_addr: None,
                    },
